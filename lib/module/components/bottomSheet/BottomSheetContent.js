...
function BottomSheetContentComponent({
      ...
      case KEYBOARD_BEHAVIOR.interactive:
        {
          ...
          if (keyboardState === KEYBOARD_STATE.SHOWN) {
            if (keyboardHeightInContainer + animatedSheetHeight.value > containerHeight) {
  ...
  const animatedPaddingBottom = useDerivedValue(() => {
    ...
    const highestSnapPoint = Math.max(animatedHighestSnapPoint.value, animatedPosition.value);
    /**
    ...
    if (animatedKeyboardState.value === KEYBOARD_STATE.SHOWN) {
      paddingBottom = overDragSafePaddingBottom + animatedKeyboardHeightInContainer.value;
    }
